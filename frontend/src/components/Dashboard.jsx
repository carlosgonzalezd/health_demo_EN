...
const Dashboard = ({ onSelectPatient, patients = [] }) => {
    const stats = [
        { label: 'Analyzed Studies', value: '4,882', trend: '+12.4%', up: true, icon: Activity, color: '#3b82f6' },
        { label: 'Active Patients', value: '1,204', trend: '+2.1%', up: true, icon: Users, color: '#10b981' },
        { label: 'AI Accuracy', value: '98.8%', trend: '+0.4%', up: true, icon: Heart, color: '#ef4444' },
        { label: 'Avg. Response Time', value: '14m', trend: '-2m', up: true, icon: Clock, color: '#8b5cf6' },
    ];

    const recentActivity = [
        { id: '1', patient: 'Arthur Morgan', type: 'Brain MRI', time: '12 min ago', status: 'Analyzed', priority: 'high' },
        { id: '2', patient: 'Sarah Jenkins', type: 'Abdominal CT', time: '24 min ago', status: 'Pending', priority: 'med' },
        { id: '3', patient: 'John Marston', type: 'Chest X-Ray', time: '1 hour ago', status: 'Reviewed', priority: 'low' },
        { id: '4', patient: 'Sadie Adler', type: 'Spinal MRI', time: '2 hours ago', status: 'Analyzed', priority: 'high' },
    ];
    ...
    return (
        <div className="dashboard-root animate-fade-in">
            <div className="section-header-v3">
                <div>
                    <h2 style={{ fontSize: '1.8rem', fontWeight: 800 }}>Radiology Control Panel</h2>
                    <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Welcome back, Dr. Romero. You have 12 reports pending signature.</p>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr', gap: '1.5rem' }}>
                <div className="glass-pane" style={{ padding: '1.5rem' }}>
                    <h3 style={{ fontWeight: 800, fontSize: '1rem', marginBottom: '1.5rem' }}>Recent Inferences</h3>
                    <table className="study-list-table">
                        <thead><tr><th>Patient</th><th>Study</th><th>Status</th><th></th></tr></thead>
                        <tbody>
                ...
                <div className="glass-pane" style={{ padding: '1.5rem' }}>
                    <h3 style={{ fontWeight: 800, fontSize: '1rem', marginBottom: '1.25rem' }}>GB10 Node Status</h3>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem', marginBottom: '5px' }}>
                                <span>Inference GPU Load</span>
                        ...
                        <div style={{ background: 'rgba(16, 185, 129, 0.05)', padding: '10px', borderRadius: '8px', borderLeft: '3px solid #10b981' }}>
                            <div style={{ fontSize: '0.75rem', fontWeight: 800, color: '#10b981' }}>OPTIMAL SYSTEM</div>
                            <p style={{ fontSize: '0.65rem', color: '#94a3b8' }}>Average inference latency: 14ms</p>
                        </div>
                    </div>
                </div>
            </div>
